...
1. Bump the version: manually trigger the "bump" workflow from the main branch
   (see here: https://github.com/crdanielbusch/primap-visualisation-tool/actions/workflows/bump.yaml).
...
1. Edit the draft release which has been created
   (see here:
   https://github.com/crdanielbusch/primap-visualisation-tool/releases).
